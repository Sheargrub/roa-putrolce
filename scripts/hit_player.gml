...
switch(my_hitboxID.attack) {
    ...
    case AT_BAIR:
    	spawn_hit_fx(get_effect_offset_x(), get_effect_offset_y(), fx_bite)
        if (my_hitboxID.hbox_num == 4 || my_hitboxID.hbox_num == 6 || my_hitboxID.hbox_num == 8) sound_play(sound_get("crush_stab"), 0, noone, 0.9, 1)
        break;
    case AT_DAIR:
        ...
        break;
    case AT_UAIR:
        if (my_hitboxID.hbox_num >= 3 && is_melee) spawn_hit_fx(get_effect_offset_x(), get_effect_offset_y(), fx_bite)
        break;
        
    case AT_FSTRONG:
    	if (my_hitboxID.hbox_num > 1 && is_melee) spawn_hit_fx(get_effect_offset_x(), get_effect_offset_y(), 304);
    ...
    case AT_DSPECIAL:
        ...
        if (hbox_num == 4 && grabbed_player_id != noone && !has_rune_petrifystatus) spawn_hit_fx(get_effect_offset_x(), get_effect_offset_y(), fx_kragg_big);
        break;
    case AT_USPECIAL:
        ...
        if (my_hitboxID.hbox_num > 2) spawn_hit_fx(get_effect_offset_x(), get_effect_offset_y(), fx_bite); 
        break;
