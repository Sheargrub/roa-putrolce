...
set_attack_value(atk, AG_LANDING_LAG, 8); // applied manually
...
set_window_value(atk, window_num, AG_WINDOW_VSPEED_TYPE, 2); // also reapplied manually for safety reasons
...
set_hitbox_value(atk, hbox_num, HG_MUNO_HITBOX_NAME         , "Landing");
hbox_num++;
