...
set_hitbox_value(atk, hbox_num, HG_HEIGHT                   , 65);
...
set_hitbox_value(atk, hbox_num, HG_LIFETIME                 , 2);
set_hitbox_value(atk, hbox_num, HG_HITBOX_X                 , 0);
set_hitbox_value(atk, hbox_num, HG_HITBOX_Y                 , -115);
set_hitbox_value(atk, hbox_num, HG_SHAPE                    , 1);
...
set_hitbox_value(atk, hbox_num, HG_LIFETIME                 , 2);
set_hitbox_value(atk, hbox_num, HG_HITBOX_X                 , 0);
set_hitbox_value(atk, hbox_num, HG_HITBOX_Y                 , -102);
...
// set_hitbox_value(atk, hbox_num, HG_VISUAL_EFFECT            , fx_bite); // spawn manually
