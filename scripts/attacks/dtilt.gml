...
set_window_value(atk, window_num                        , AG_WINDOW_STANCE_LENGTHS, [24, 24, 24, 24]);
...
set_window_value(atk, window_num                        , AG_WINDOW_HUNGER_GAIN, 10); // Tampered with, see attack_update.gml
