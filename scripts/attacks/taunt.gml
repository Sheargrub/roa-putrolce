...
set_window_value(atk, window_num                        , AG_WINDOW_SFX, asset_get("sfx_frog_dspecial_spit"));
...
set_hitbox_value(atk, hbox_num, HG_PROJECTILE_HSPEED        , 2);
set_hitbox_value(atk, hbox_num, HG_PROJECTILE_VSPEED        , -2);
set_hitbox_value(atk, hbox_num, HG_PROJECTILE_GRAVITY       , 0.15);
hbox_num++;