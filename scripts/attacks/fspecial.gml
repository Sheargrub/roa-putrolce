...
set_window_value(atk, window_num                        , AG_WINDOW_STANCE_LENGTHS, [13, 8, 9, 12]);
...
set_window_value(atk, window_num                        , AG_WINDOW_HAS_STANCE_LENGTHS, 1);
set_window_value(atk, window_num                        , AG_WINDOW_STANCE_LENGTHS, [4, 6, 6, 9]);
...
set_hitbox_value(atk, hbox_num, HG_WIDTH                    , 43);
set_hitbox_value(atk, hbox_num, HG_HEIGHT                   , 54);
